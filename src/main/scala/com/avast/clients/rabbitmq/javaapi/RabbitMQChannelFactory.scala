...
//
//import com.avast.clients.rabbitmq.RabbitMQFactory.{DefaultListeners, ServerChannel}
//import com.avast.clients.rabbitmq.api.{ChannelListener, ConnectionListener, ConsumerListener}
//import com.avast.clients.rabbitmq.{RabbitMQConnectionConfig, RabbitMqFactoryInfo, RabbitMQFactory => ScalaFactory}
...
//
//  override def info: RabbitMqFactoryInfo = scalaFactory.info
//
