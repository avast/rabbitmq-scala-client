...
//import com.avast.clients.rabbitmq.AbstractStreamedDelivery
...
//
//  private def streamedDelivery[A](body: A, properties: MessageProperties) = new AbstractStreamedDelivery[Task, A] {
