...
import com.avast.clients.rabbitmq.api.{PullResult => ScalaResult, RabbitMQPullConsumer => ScalaPullConsumer}
import com.avast.clients.rabbitmq.javaapi.JavaConverters._
import com.typesafe.scalalogging.StrictLogging

import scala.concurrent.{ExecutionContext, Future}

private abstract class DefaultRabbitMQPullConsumer private[javaapi] (scalaConsumer: ScalaPullConsumer[Future, Bytes])(
