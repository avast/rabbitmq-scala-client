...
class PoisonedMessageHandlerLiveTest extends TestBase with ScalaFutures {
  ...
  //
  //      rabbitConnection
  //        .newConsumer("testingWithPoisonedMessageHandler", Monitor.noOp(), List(h)) {
  ...
  //
  //      rabbitConnection.newStreamingConsumer[Bytes]("testingStreamingWithPoisonedMessageHandler", Monitor.noOp(), List(pmh)).withResource { cons =>
  //        cons.deliveryStream
  //          .evalMap {
  //            _.handleWith { _ =>
  //              Task {
  ...
  //      }
  //
  //      rabbitConnection.newStreamingConsumer[Bytes]("testingStreamingWithPoisonedMessageHandler", monitor, List(pmh)).withResource { cons =>
  //        cons.deliveryStream
